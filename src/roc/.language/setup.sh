...
mkdir '/opt/roc'
pushd '/tmp/roc'
wget -q 'https://github.com/roc-lang/roc/releases/download/alpha4-rolling/roc-linux_x86_64-alpha4-rolling.tar.gz'
printf '%s  %s\n' 'bae71a1099fb1f7131d849d865b7cead3f91b3fa' 'roc-linux_x86_64-alpha4-rolling.tar.gz' | sha1sum --check -
