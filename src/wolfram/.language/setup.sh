...
mkdir '/opt/wolfram'
pushd '/opt/wolfram'
wget -q 'https://files.wolframcdn.com/WolframEngine/14.3.0.0/WolframEngine_14.3.0_LIN.sh'
printf '%s  %s\n' '5b97e53392b07693c91ac2b4139613d211e6d3f0' 'WolframEngine_14.3.0_LIN.sh' | sha1sum --check -
