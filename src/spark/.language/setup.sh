...
mkdir -p '/tmp/alr'
pushd '/tmp/alr'
wget -q 'https://github.com/alire-project/alire/releases/download/v2.1.0/alr-2.1.0-bin-x86_64-linux.zip'
printf '%s  %s\n' '30daf6f5189624e1cd1516ff6e8386bc9a13587f' 'alr-2.1.0-bin-x86_64-linux.zip' | sha1sum --check -
